...
func (ps *ConfigStore) GetGroup(id, version string, ctx context.Context) (*FreeGroup, *er.ErrorResponse) {
...
func (ps *ConfigStore) GetGroupVersions(id string, ctx context.Context) ([]*FreeGroup, *er.ErrorResponse) {
	span := tracer.StartSpanFromContext(ctx, "dbGetGroup")
	defer span.Finish()
...
func (ps *ConfigStore) GetAllGroups(ctx context.Context) ([]*FreeGroup, *er.ErrorResponse) {
...
func (ps *ConfigStore) DeleteGroup(id, version string, ctx context.Context) (map[string]string, *er.ErrorResponse) {
...
func (ps *ConfigStore) DeleteGroupVersions(id string, ctx context.Context) (map[string]string, *er.ErrorResponse) {
...
func (ps *ConfigStore) Group(group *FreeGroup, creating bool, ctx context.Context) (*FreeGroup, *er.ErrorResponse) {
...
func (ps *ConfigStore) DeleteConfigsByLabels(id, version, labels, newVersion string, ctx context.Context) (*FreeGroup, *er.ErrorResponse) {
...
func (ps *ConfigStore) GetConfigsByLabels(id, version, labels string, ctx context.Context) (*FreeGroup, *er.ErrorResponse) {
